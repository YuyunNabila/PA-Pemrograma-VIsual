...
Partial Class Form5
    ...
    Private Sub InitializeComponent()
        ...
        PictureBox6.Location = New Point(-103, 313)
        ...
        PictureBox2.Location = New Point(304, 428)
        ...
        PictureBox4.Location = New Point(972, 268)
        ...
        ' flpBunga
        ' 
        flpBunga.AutoScroll = True
        flpBunga.BackColor = Color.Transparent
        flpBunga.Location = New Point(319, 76)
        flpBunga.Margin = New Padding(2)
        flpBunga.Name = "flpBunga"
        flpBunga.Size = New Size(846, 620)
        flpBunga.TabIndex = 79
        ' 
        ' PictureBox1
        ' 
        PictureBox1.BackColor = Color.Transparent
        PictureBox1.Image = CType(resources.GetObject("PictureBox1.Image"), Image)
        PictureBox1.Location = New Point(1044, -76)
        ...
        ' btnCari
        ' 
        btnCari.BackColor = Color.RosyBrown
        btnCari.BorderStyle = BorderStyle.None
        btnCari.Font = New Font("Bell MT", 18F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        btnCari.Location = New Point(382, 12)
        btnCari.Margin = New Padding(2)
        btnCari.Name = "btnCari"
        btnCari.Size = New Size(771, 41)
        btnCari.TabIndex = 81
        ' 
        ' Label3
        ' 
        ...
        PictureBox5.Location = New Point(141, 474)
        PictureBox5.Margin = New Padding(2)
        PictureBox5.Name = "PictureBox5"
        PictureBox5.Size = New Size(129, 160)
    ...
    Friend WithEvents flpBunga As FlowLayoutPanel
    Friend WithEvents PictureBox1 As PictureBox
    Friend WithEvents btnCari As TextBox
