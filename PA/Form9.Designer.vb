...
Partial Class Form9
    ...
    Private Sub InitializeComponent()
        ...
        PictureBox3.Location = New Point(159, 28)
        ...
        btnRiwayat.Location = New Point(0, 278)
        btnRiwayat.Margin = New Padding(4)
        btnRiwayat.Name = "btnRiwayat"
        btnRiwayat.Size = New Size(316, 70)
        ...
        btnDaftarPesanan.Location = New Point(0, 207)
        ...
        btnTambahBunga.Location = New Point(0, 137)
        ...
        pnlSidebar.TabIndex = 108
        ' 
        ' PictureBox5
        ' 
        PictureBox5.BackColor = Color.Transparent
        PictureBox5.Image = CType(resources.GetObject("PictureBox5.Image"), Image)
        PictureBox5.Location = New Point(-66, 370)
        PictureBox5.Margin = New Padding(2)
        PictureBox5.Name = "PictureBox5"
        PictureBox5.Size = New Size(241, 250)
        ...
        Label3.Location = New Point(332, 13)
        ...
        txtPencarian.Location = New Point(397, 23)
        txtPencarian.Margin = New Padding(2)
        txtPencarian.Name = "txtPencarian"
        txtPencarian.Size = New Size(757, 41)
        txtPencarian.TabIndex = 120
        ' 
        ' flpPesanan
        ' 
        flpPesanan.BackColor = Color.Transparent
        flpPesanan.Location = New Point(323, 91)
        flpPesanan.Name = "flpPesanan"
        flpPesanan.Size = New Size(831, 593)
        flpPesanan.TabIndex = 121
        ' 
        ' PictureBox1
        ' 
        PictureBox1.BackColor = Color.Transparent
        PictureBox1.Image = My.Resources.Resources._4
        PictureBox1.Location = New Point(160, 431)
    ...
    Friend WithEvents flpPesanan As FlowLayoutPanel
